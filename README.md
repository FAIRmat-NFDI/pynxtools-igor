...
# `pynxtools-igor`: A `pynxtools` reader for Wavemetrics Igor Pro data

`pynxtools-igor` is a `pynxtools` reader plugin for Wavemetrics Igor Pro data.
...
More information about this pynxtools plugin is available in the [documentation](https://fairmat-nfdi.github.io/pynxtools-igor/). You will find information about getting started, how-to guides, the supported file formats, how to get involved, and much more there.
